...
//   products?: ProductData[]; // Make sure this exists in your state
...
//     const handleSelectChange = (selected: string, formIndex: number, sellerDetailIndex: number) => {
//       const seller = sellers.find(s => String(s.id) === selected);
//       if (!seller) return;

//       setFormDataArray(prev =>
//         prev.map((item, i) => {
//           if (i === formIndex) {
//             const updatedSellerDetails = item.sellerdetails.map((detail, j) => {
//               if (j === sellerDetailIndex) {
//                 return {
//                   ...detail,
...
//             return {
//               ...item,
//               sellerdetails: updatedSellerDetails,
//             };
//           }
//           return item;
//         })
...
//         const amount = parseFloat(product.product_total_amount as string);
//             return sum + (isNaN(amount) ? 0 : amount);
//         }, 0);

//       const amountInWords = formatAmountInWords(totalAmount);

//       updatedFormData[index].invoicing_amount = totalAmount.toFixed(0);
//       updatedFormData[index].invoicing_total_amount = totalAmount.toFixed(0);
//       updatedFormData[index].total_amount_in_words = amountInWords;
...
//     ) => {
//       setFormDataArray((prev) => {
//         return prev.map((seller, i) => {
//           if (i === sellerIndex) {
//             const updatedDetails = seller.sellerdetails.map((detail, j) =>
//               j === detailIndex ? { ...detail, [field]: value } : detail
//             );

//             let updatedProducts = [...(seller.products ?? [])];
//             if (field === 'product_name') {
//               if (updatedProducts[detailIndex]) {
//                 updatedProducts[detailIndex].product_name = value as string;
//               } else {
...
//     const handleDeleteSellerDetails = (sellerIndex: number, detailIndex: number) => {
//       setFormDataArray((prev) => {
//         return prev.map((seller, i) => {
//           if (i === sellerIndex) {
//             return {
//               ...seller,
//               sellerdetails: seller.sellerdetails.filter((_, idx) => idx !== detailIndex),
//             };
//           }
//           return seller;
//         });
...
//     const handleAddSellerRow = (index: number) => {
//         setFormDataArray((prev) => {
//           return prev.map((seller, i) => {
//             if (i === index) {
//               return {
...
//                         <TableRow key={`${index}-${sellerIndex}`}>
//                           <TableCell>
//                             <Select 
//                                 name="seller_assigned" 
//                                 value={sellerdetail.seller_assigned ?? ''} 
//                                 onValueChange={(value: string) => handleSelectChange(value, index,sellerIndex)} // pass index here
//                               >
...
//                                   <SelectValue 
//                                     placeholder={
//                                       sellers.find(s => String(s.id) === String(sellerdetail.seller_assigned))?.name || "Select Seller"
//                                     } 
//                                   />
//                                 </SelectTrigger>
//                                 <SelectContent>
...
//                           <TableCell>
//                             <Input
//                               value={sellerdetail.product_name}
//                               onChange={(e) => handleSellerDetailsChange(index, sellerIndex, "product_name", e.target.value)}
...
//                               onChange={(e) => handleSellerDetailsChange(index, sellerIndex, "quantity", e.target.value)}
...
//                               onChange={(e) => handleSellerDetailsChange(index, sellerIndex, "seller_offer_rate", e.target.value)}
...
//                               onChange={(e) => handleSellerDetailsChange(index, sellerIndex, "gst", e.target.value)}
//                               placeholder="GST"
//                             />
//                           </TableCell> 
//                           <TableCell>
...
//                               onChange={(e) => handleSellerDetailsChange(index, sellerIndex, "buyer_offer_rate", e.target.value)}
...
//                               onChange={(e) => handleSellerDetailsChange(index, sellerIndex, "final_shipping_value", e.target.value)}
...
//                               onChange={(e) => handleSellerDetailsChange(index, sellerIndex, "total_amount", e.target.value)}
...
//                               variant="destructive"
//                               size="sm"
//                               onClick={() => handleAddSellerRow(index)}
//                               className="text-[12px] px-2 py-1 cursor-pointer bg-green-800 mr-2"
//                             >
...
//                               variant="destructive"
//                               size="sm"
//                               onClick={() => handleDeleteSellerDetails(index, sellerIndex)}
...
//       {formDataArray.map((formData, formIndex) => (

//         formData.seller_name && (
//             formData.sellerdetails?.map((sellerDetail, sellerIndex) => (
//               sellerDetail.seller_assigned && (
//                 <div key={`${formIndex}-${sellerIndex}`} className="mb-8">

//                     <div className="flex justify-between">
//                           <h2 className="text-[18px] font-inter-semibold">Seller #{sellerIndex + 1}</h2>
//                     </div>
...
//                             id="shippingName"
//                             name="shipping_name"
//                             value={formDataArray[formIndex].shipping_name || ''}
//                             onChange={(e) => handleFormDataChange(e, formIndex)}
...
//                             id="addressLine1"
//                             name="address_line_1"
//                             value={formDataArray[formIndex].address_line_1 || ''}
//                             maxLength={50}
//                             onChange={(e) => handleFormDataChange(e, formIndex)}
...
//                             id="address2"
//                             name="address_line_2"
//                             value={formDataArray[formIndex].address_line_2 || ''}
//                             maxLength={50}
//                             onChange={(e) => handleFormDataChange(e, formIndex)}
//                             placeholder="Max. 50 characters"
//                             className="bg-white border"
...
//                             id="sellerPincode"
//                             name="seller_pincode"
//                             value={formDataArray[formIndex].seller_pincode || ''}
//                             onChange={(e) => handleFormDataChange(e, formIndex)}
...
//                             value={formDataArray[formIndex].seller_contact_person_name || ''}
//                             onChange={(e) => handleFormDataChange(e, formIndex)}
...
//                             value={formDataArray[formIndex].seller_contact_person_number || ''}
//                             onChange={(e) => handleFormDataChange(e, formIndex)}
...
//                             <DatePicker 
//                             date={formDataArray[formIndex].invoicing_invoice_generate_date ? new Date(formDataArray[formIndex].invoicing_invoice_generate_date) : undefined} 
//                             setDate={(date) => handleSellerDateChange(date, "invoicing_invoice_generate_date",formIndex)} 
//                             placeholder="DD-MM-YYYY" 
...
//                           value={formDataArray[formIndex].invoicing_invoice_number || ''}
//                           onChange={(e) => handleFormDataChange(e, formIndex)}
...
//                           id="invoiceTo"
//                           name="invoice_to"
//                           value={formDataArray[formIndex].invoice_to || ''}
//                           onChange={(e) => handleFormDataChange(e, formIndex)}
...
//                           value={formDataArray[formIndex].invoice_address || ''}
//                           onChange={(e) => handleFormDataChange(e, formIndex)}
...
//                           id="invoiceGSTIN"
//                           name="invoice_gstin"
//                           value={formDataArray[formIndex].invoice_gstin || ''}
//                           onChange={(e) => handleFormDataChange(e, formIndex)}
...
//                             <TableRow key={`${formIndex}-${productIndex}`}>
//                               <TableCell>
//                                 <Input
//                                   value={product.product_name}
//                                   onChange={(e) => handleProductChange(formIndex, productIndex, "product_name", e.target.value)}
//                                   placeholder="Product Name"
//                                 />
//                               </TableCell>
//                               <TableCell>
//                                 <Input
//                                   value={product.hsn}
//                                   onChange={(e) => handleProductChange(formIndex, productIndex, "hsn", e.target.value)}
...
//                                   onChange={(e) => handleProductChange(formIndex, productIndex, "rate_per_kg", e.target.value)}
...
//                                   onChange={(e) => handleProductChange(formIndex, productIndex, "total_kg", e.target.value)}
...
//                                   onChange={(e) => handleProductChange(formIndex, productIndex, "product_total_amount", e.target.value)}
//                                   placeholder="Total Amount"
//                                 />
//                               </TableCell>
//                               <TableCell>
...
//                                   type="button"
//                                   size="sm"
//                                   onClick={() => handleAddProduct(formIndex)}
//                                   className="text-[12px] px-2 py-1 cursor-pointer bg-green-800"
//                                   title="Add More"
//                                 >
...
//                                   variant="destructive"
//                                   size="sm"
//                                   onClick={() => handleDeleteProduct(formIndex, productIndex)}
//                                   className="text-[12px] px-2 py-1 cursor-pointer mx-2"
//                                 >
//                                   <Trash2 className="h-4 w-4" />
//                                 </Button>
...
//                           value={formDataArray[formIndex].invoicing_amount || ''}
...
//                             value={formDataArray[formIndex].packaging_expenses || ''}
...
//                           id="expenses"
//                           name="expenses"
//                           value={formDataArray[formIndex].expenses || ''}
...
//                           value={formDataArray[formIndex].invoicing_total_amount || ''}
//                           placeholder="Please enter total amount"
//                           onChange={(e) => handleFormDataChange(e, formIndex)}
//                           className="bg-white border"
//                           readOnly
...
//                             value={formDataArray[formIndex].total_amount_in_words || ''}
...
//                             id="noOfBoxes"
//                             name="no_of_boxes"
//                             value={formDataArray[formIndex].no_of_boxes || ''}
//                             onChange={(e) => handleFormDataChange(e, formIndex)}
...
//                             value={formDataArray[formIndex].weight_per_unit || ''}
//                             onChange={(e) => handleFormDataChange(e, formIndex)}
//                             placeholder="weight"
//                             className="bg-white border"
//                           />
...
//                             <Input
//                               name="length"
//                               value={formDataArray[formIndex].length || ''}
//                               onChange={(e) => handleFormDataChange(e, formIndex)}
//                               placeholder="length"
//                               className="bg-white border"
//                             />
//                             <Input
//                               name="width"
//                               value={formDataArray[formIndex].width || ''}
//                               onChange={(e) => handleFormDataChange(e, formIndex)}
//                               placeholder="width"
//                               className="bg-white border"
//                             />
//                             <Input
//                               name="height"
//                               value={formDataArray[formIndex].height || ''}
//                               onChange={(e) => handleFormDataChange(e, formIndex)}
//                               placeholder="height"
//                               className="bg-white border"
//                             />
...
//                           <select
//                             name="dimension_unit"
//                             value={formDataArray[formIndex].dimension_unit || 'cm'}
//                             onChange={(e) => handleFormDataChange(e, formIndex)}
...
//                           <Label className="text-[15px] font-inter-medium">Invoice Generate Date</Label>
//                             <DatePicker 
//                             date={formDataArray[formIndex].invoice_generate_date ? new Date(formDataArray[formIndex].invoice_generate_date) : undefined} 
//                             setDate={(date) => handleSellerDateChange(date, "invoice_generate_date",formIndex)} 
//                             placeholder="DD-MM-YYYY" 
//                           />
//                         </div>
...
//                             id="invoiceValue"
//                             name="invoice_value"
//                             value={formDataArray[formIndex].invoice_value || ''}
//                             onChange={(e) => handleFormDataChange(e, formIndex)}
...
//                             id="invoiceNumber"
//                             name="invoice_number"
//                             value={formDataArray[formIndex].invoice_number || ''}
//                             onChange={(e) => handleFormDataChange(e, formIndex)}
//                             placeholder="Please enter invoice number"
//                             className="bg-white border"
//                           />
...
//                             value={formDataArray[formIndex].delivery_address || ''}
//                             onChange={(e) => handleFormDataChange(e, formIndex)}
...
//                           <DatePicker 
//                             date={formDataArray[formIndex].order_ready_date ? new Date(formDataArray[formIndex].order_ready_date) : undefined} 
//                             setDate={(date) => handleSellerDateChange(date, "order_ready_date",formIndex)} 
//                             placeholder="DD-MM-YYYY" 
//                           />
//                         </div>
...
//                           <DatePicker 
//                             date={formDataArray[formIndex].order_dispatch_date ? new Date(formDataArray[formIndex].order_dispatch_date) : undefined} 
//                             setDate={(date) => handleSellerDateChange(date, "order_dispatch_date",formIndex)} 
//                             placeholder="DD-MM-YYYY" 
//                           />
//                         </div>
//                         {formDataArray[formIndex].order_dispatch_date && (
//                         <div className="space-y-2 w-[80%]">
//                           <Label className="text-[15px] font-inter-medium">Order Delivery Date</Label>
//                           <DatePicker 
//                             date={formDataArray[formIndex].order_delivery_date ? new Date(formDataArray[formIndex].order_delivery_date) : undefined} 
//                             setDate={(date) => handleSellerDateChange(date, "order_delivery_date",formIndex)} 
//                             placeholder="DD-MM-YYYY" 
//                           />
//                         </div>
//                         )}
