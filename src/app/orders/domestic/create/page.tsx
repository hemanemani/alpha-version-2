...
import { Check, ChevronsUpDown, SquarePlus, SquareX } from "lucide-react"
      ...
      <form className="px-20 py-6" onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-2 mb-6 mt-4">
          ...
          <div className="space-y-2 w-[80%]">
            ...
            <Input id="name" name="name" value={formData.name || ''} onChange={handleChange} placeholder="Please enter name" className={`bg-white dark:bg-[#000] ${formErrors.name ? "border-red-500" : "border"}`} />
          </div>
          <div className="space-y-2 w-[80%]">
            <Label htmlFor="contactNumber" className="text-[15px] font-inter-medium">Contact Number</Label>
              <Input id="contactNumber" name="mobile_number" value={formData.mobile_number || ''} onChange={handleChange} placeholder="Please enter contact number" className={`bg-white dark:bg-[#000] ${formErrors.mobile_number ? "border-red-500" : "border"}`}/>
          </div>
        </div>
                      ...
                      <Accordion type="multiple" defaultValue={["seller", "invoice", "packaging"]}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 gap-2 mb-6 mt-4">
                                <div className="space-y-2 w-[80%]">
                                  ...
                                  <Input
                                    ...
                                    className="bg-gray-100 dark:bg-[#111111] border"
                                  />
                                </div>
                              </div>
                              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-2 mb-6 mt-4">
                              ...
                              <div className="space-y-2 w-[80%]">
                                  <Label htmlFor={`logisticsThrough-${index}`} className="text-[15px] font-inter-medium">Logistics Through</Label>
                                    <select
                                      id={`logisticsThrough-${index}`}
                                      name="logistics_through"
                                      value={formDataArray[index]?.logistics_through || ''}
                                      onChange={(e) => handleFormDataChange(e, index)}
                                      className="w-[100%] p-[8px] text-[13px] text-[#827482] border-2 bg-white dark:bg-[#000] border-[#e5e7eb] dark:border-[#1e2939] text-sm rounded-lg cursor-pointer"
                                    >
                            ...
                            <Card>
                              ...
                              <div className="space-y-2 w-[80%] flex items-end justify-end">
                                <RainbowButton
                                  ...
                                  className={`w-full ${isPdfLoading ? "opacity-50 cursor-not-allowed" : ""} bg-black text-white dark:bg-[#111111] dark:text-black dark:hover:bg-black text-[14px] cursor-pointer font-inter-semibold`}
                        ...
                        <AccordionItem value="packaging">
                          ...
                          <AccordionContent>
                            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-2 mb-6 mt-4">
                              <div className="space-y-2 w-[80%]">
                                <Label htmlFor={`logisticsAgency-${index}`} className="text-[15px] font-inter-medium">Logistics Agency</Label>
                                  <Input
                              ...
                              <div className="space-y-2 w-[80%]">
                                <Label htmlFor={`noOfBoxes-${index}`} className="text-[15px] font-inter-medium">No. of Boxes</Label>
                                <Input
                                  id={`noOfBoxes-${index}`}
                                  name="no_of_boxes"
                              ...
                              <div className="space-y-2 w-[80%]">
                                <Label htmlFor={`weightPerUnit-${index}`} className="text-[15px] font-inter-medium">Weight (per unit in Kg)</Label>
                                <Input
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-2 mb-6 mt-4">
                              ...
                              <div className="mt-1">
                                <select
                                  ...
                                  onChange={(e) => handleFormDataChange(e, index)}
                                  className="w-[100%] p-[8px] text-[13px] text-[#827482] border-[#e5e7eb] dark:border-[#1e2939] bg-white dark:bg-[#000] border text-sm rounded-lg cursor-pointer"
                                >
