...
//     const [sellerFormDataArray, setSellerFormDataArray] = useState<SellerDetail[]>([
//       {
//         sellerdetails: [
//           {
//             seller_assigned: '',
...
//       const handleSelectChange = (selected: string,rowIndex: number) => {
...
//                   </TableRow>
//                 </TableHeader>
//                 {sellerFormDataArray.map((formData, index) => (
...
//                                 onValueChange={(value: string) => handleSelectChange(value,index)}
//                                 >
