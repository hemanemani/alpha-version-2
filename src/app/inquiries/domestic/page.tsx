    ...
    <div>
      <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <a href="/analytics" className="text-black dark:text-white underline underline-offset-2 text-[14px] font-inter-semibold">
              View Analytics
            </a>
            )}
          </div> 
        ...
        {(
          ...
          <Link href="/inquiries/domestic/create">
            <RainbowButton className="bg-black text-white dark:bg-white dark:text-black text-[11px] capitalize px-2 py-1 h-[37px] cursor-pointer font-inter-semibold">
              + Add New Inquiry
            </RainbowButton>
          </Link>
        )}
        ...
        {accessLevel === "master" && (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-40 bg-white border border-[#d9d9d9] rounded-lg dark:bg-[#111111]">
              ...
              <DropdownMenuItem
                className="flex items-center gap-2 text-sm font-inter-semibold text-gray-900 cursor-pointer py-2 dark:hover:bg-[#2C2D2F] dark:text-white"
                onClick={exportToPDF}
              >
