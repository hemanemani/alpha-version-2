...
const SellerUploadData:React.FC<UploadProps> = ({uploadsData,filteredData,setFilteredData,isLoading}) => {
  ...
  const handleDelete = async(id: number) => {
    ...
    try {
        const response = await axiosInstance.delete(`/bulk-seller-data/${id}`, {
            headers: {
...
export default SellerUploadData;
